...
/**
    ...
    public void gradeAndSaveQuiz(QuizSubmitRequestDto request) {
        ...
        // 기존 엔티티의 필드명(totalQuestions, correctCount 등)을 그대로 유지합니다.
        ...
        for (var answerDto : request.answers()) {
            ...
            // [정보은닉] 단어의 정답(engligetEnglishWord)과 사용자의 입력값(submittedAnswer)을 비교합니다.
            // 대소문자 구분을 없애기 위해 equalsIgnoreCase 사용을 권장합니다.
            ...
            if (isCorrect) {
                ...
                // QuizResult와 ErrorNote의 양방향 연관관계를 활용합니다.
